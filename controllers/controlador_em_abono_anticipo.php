...
class controlador_em_abono_anticipo extends \gamboamartin\empleado\controllers\controlador_em_abono_anticipo {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass())
    {
        ...
        $this->titulo_lista = 'Abono';

        $this->sidebar['lista']['titulo'] = "Abonos";
