...
class controlador_em_metodo_calculo extends \gamboamartin\empleado\controllers\controlador_em_metodo_calculo {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass())
    {
        ...
        $this->titulo_lista = 'Metodo Calculo';

        $this->sidebar['lista']['titulo'] = "Metodo Calculo";
        $this->sidebar['lista']['menu'] = array(
            $this->menu_item(menu_item_titulo: "Alta", link: $this->link_alta,menu_seccion_active: true,
                menu_lateral_active: true));

        $this->sidebar['alta']['titulo'] = "Alta Metodo Calculo";
        ...
        $this->sidebar['modifica']['titulo'] = "Modifica Metodo Calculo";
