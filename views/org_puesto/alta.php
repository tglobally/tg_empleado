...
<?php include 'templates/org_puesto/alta/secciones.php'; ?>
        ...
        <div class="  form-main" id="form">
            <form method="post" action="./index.php?seccion=org_puesto&accion=alta_bd&session_id=<?php echo $controlador->session_id; ?>" class="form-additional">
                ...
                <div class="buttons col-md-12">
                    ...
                    <div class="col-md-6 ">
                        <a href="index.php?seccion=org_puesto&accion=lista&session_id=<?php echo $controlador->session_id; ?>"  class="btn btn-info btn-guarda col-md-12 ">Regresar</a>
                    </div>
                </div>
            </form>
        </div>
