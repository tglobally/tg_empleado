...
<?php include 'templates/org_puesto/lista/secciones.php'; ?>
            ...
            <table class="table table-dark">
                ...
                <?php foreach ($controlador->registros as $registro){
                    ...
                    <tr>
                        ...
                        <th><?php echo $registro->org_puesto_id; ?></th>
                        <th><?php echo $registro->org_puesto_codigo; ?></th>
                        <th><?php echo $registro->org_puesto_codigo_bis; ?></th>
                        <th><?php echo $registro->org_puesto_descripcion; ?></th>
                    </tr>
                <?php } ?>
