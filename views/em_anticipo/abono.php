        ...
        <div class="  form-main" id="form">
            <form method="post" action="<?php echo $controlador->link_em_abono_anticipo_alta_bd; ?>&em_anticipo_id=<?php echo $controlador->em_anticipo_id; ?>" class="form-additional">
                ...
                <div class="buttons col-md-12">
                    ...
                    <div class="col-md-6 btn-ancho">
                        <a href="index.php?seccion=em_anticipo&accion=anticipo&session_id=<?php echo $controlador->session_id; ?>&registro_id=<?php echo $controlador->registro_id; ?>"  class="btn btn-info btn-guarda col-md-12 ">Regresar</a>
                    </div>
