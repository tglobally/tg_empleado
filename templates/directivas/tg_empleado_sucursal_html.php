...
class tg_empleado_sucursal_html extends em_html {

    private function asigna_inputs(controlador_tg_empleado_sucursal $controler, array $inputs): array|stdClass
    {
    ...
    public function genera_inputs(controlador_tg_empleado_sucursal $controler, array $keys_selects = array()): array|stdClass
    {
    ...
    public function select_tg_empleado_sucursal_id(int $cols, bool $con_registros, int $id_selected, PDO $link,
