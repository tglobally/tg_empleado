...
class tg_empleado_sucursal extends _modelo_parent
{
    ...
    public function __construct(PDO $link)
    {
        ...
        $columnas = array($tabla => false, 'em_empleado' => $tabla, 'em_registro_patronal'=> 'em_empleado',
            'com_sucursal' => $tabla, 'org_sucursal' => $tabla, 'org_empresa' => 'org_sucursal', 'com_cliente' => 'com_sucursal',
            'dp_calle_pertenece' => 'com_sucursal', 'dp_calle' => 'dp_calle_pertenece', 'fc_csd' => 'em_registro_patronal',
